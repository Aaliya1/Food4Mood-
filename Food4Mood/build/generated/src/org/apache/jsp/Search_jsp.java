...
public final class Search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <link href=\"css/style.css\" rel=\"stylesheet\">\n");
      out.write("    <script>\n");
      out.write("        function showMenu(int r)\n");
      out.write("        { \n");
      out.write("            var r1 = r;\n");
      out.write("            var xhr= new XMLHttpRequest();\n");
      out.write("            xhr.open(\"Get\",\"ShowMenu.jsp?id=\"+r1);\n");
      out.write("            xhr.send(null);\n");
      out.write("            xhr.onreadystatechange()=function()\n");
      out.write("            {\n");
      out.write("                if(xhr.readyState == 4 && xhr.status == 200)\n");
      out.write("                {\n");
      out.write("                    document.getElementById('menu').innerHTML = xhr.responseText;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("        \n");
 ...
 while(rs.next())
 {
      ...
      out.write("\n");
      out.write("  <div class=\"row\">\n");
      out.write("      <div class=\"col-lg-3\"><br><br><br>\n");
      out.write("          <img class=\"shops\" src=\"./view?id=");
      out.print(rs.getString(1));
      out.write("\" width=\"250px\" height=\"120px\"alt=");
      ...
      out.write("<br>Email-id:");
      out.print(rs.getString(5));
      out.write("</p>\n");
      out.write("                <button class=\"btn btn-primary\" href=\"#\" onclick=\"showMenu(");
      out.print(rs.getString(1));
      out.write(")\">View Menu <span class=\"glyphicon glyphicon-chevron-right\"></span></button>\n");
      out.write("            </div>\n");
